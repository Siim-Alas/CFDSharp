...
namespace CFDSharpClassLibrary.PotentialFlow
{
    ...
    public static class Velocity
    {
        ...
        /// </summary>
        /// <param name="r">The point at which the velocity is to be computed.</param>
        /// <param name="locationOfThePointSource">
        /// The location of the point source causing the velocity.
        /// </param>
        /// <param name="strengthOfThePointSource">
        /// The strength of the point source causing the velocity.
        /// </param>
        /// <returns>The velocity at the point r.</returns>
        public static Vector3 ComputeSteadyState(
            Vector3 r, 
            Vector3 locationOfThePointSource, 
            double strengthOfThePointSource)
        {
            Vector3 dr = r - locationOfThePointSource; // A vector pointing from the point source to r
            Vector3 velocityPotential =
                (float)(strengthOfThePointSource / (4 * Math.PI * dr.LengthSquared())) * dr;
            return velocityPotential;
        }
        /// <summary>
