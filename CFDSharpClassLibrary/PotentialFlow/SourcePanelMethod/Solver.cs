...
namespace CFDSharpClassLibrary.PotentialFlow.SourcePanelMethod
{
    ...
    {
        /// <summary>
        /// Mutates the strengths of the source panels in the given array such that
        /// the resulting flow is perpendicular to the normal vector of every panel.
        /// </summary>
        /// <param name="sourcePanels">The array of source panels to be mutated.</param>
        /// <param name="vInf">
